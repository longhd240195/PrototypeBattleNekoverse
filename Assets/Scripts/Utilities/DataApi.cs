...
public class DataApi : PersistantAndSingletonBehavior<DataApi>
{
    ...
    public List<MapLevelIdResponse> GetMapLevelIdResponse() { return mapLevelIdResponse; }
    public void SetMapLevelIdResponse(List<MapLevelIdResponse> value) { mapLevelIdResponse = value; }
